...
<head>
	<meta charset="UTF-8">
	<title>Inzenjerska komora Srbije</title>
...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="logo"><h2>INZENJERSKA KOMORA SRBIJE</h2></li>
...
<footer>
	...
	<div class="copyrights">
		...
		<p>&copy; <?= date('Y') ?> Inzenjerska komora Srbije. Bulevar Vojvode Misica 37, Beograd  email: ingkombg@ingkomora.rs </p>
